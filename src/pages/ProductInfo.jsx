                    ...
                    {(
                        <>
                            <div className="relative w-full space-y-4 lg:max-w-3xl mx-auto rounded-xl overflow-hidden">
                                ...
                                {unitLoad ? (
                                    <div className="flex justify-center items-center w-full h-full">
                                        <div className="w-full h-full rounded-lg bg-gray-300 dark:bg-pink-500 animate-pulse flex items-center justify-center">
                                            <svg class="w-12 h-12 stroke-gray-500" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div className="mt-6 sm:mt-8 lg:mt-0">
                                {unitLoad ? (
                                    <h1 className="h-5 bg-gray-300 rounded-full animate-pulse w-60 mb-4"></h1>
                                ) : (
                                ...
                                <div className="mt-4 sm:items-center sm:gap-4 sm:flex">
                                    {unitLoad ? (
                                        <p className="h-8 bg-gray-300 rounded-full animate-pulse w-40 mb-4"></p>
                                    ) : (
                                ...
                                <div className='grid sm:grid-cols-2'>
                                    ...
                                    <SmallLabel label="Loan Tenure" text={unitLoad ? (<SmallSpin size={20} />) : unit.years+" years"} />
                                ...
                                <p className="mb-6 text-gray-500 dark:text-gray-400">
                                    {unitLoad ? (
                                        <>
                                            ...
                                            <div className=' w-full flex justify-between items-start animate-pulse'>
                                                <div className="block">
                                                    <h3 className='h-3 bg-gray-300 rounded-full  w-60 mb-4'></h3>
                                                    <h3 className='h-3 bg-gray-300 rounded-full  w-58 mb-4'></h3>
                                                    <p className='h-2 bg-gray-300 rounded-full w-40 mb-2.5'></p>
                                                    <p className='h-2 bg-gray-300 rounded-full w-50 mb-2.5'></p>
                                                    <p className='h-2 bg-gray-300 rounded-full w-50 mb-2.5'></p>
                                                </div>
                                            </div>
                                        </>
