    ...
    return (
        <>
            ...
            <div class="grid gap-4 mb-4 sm:grid-cols-3 pb-2 border-b dark:border-gray-500">
                <FormSelect name="income" label="Source of income" id="income" value={applicant.income} onchange={handleChange} require={true}>
                ...
                <FormInput label="Monthly/Daily Rate" type="text" name="rate" id="rate" value={applicant.rate} onchange={handleChange} placeholder="₱1,000" require={true} />
            ...
            <div class="grid gap-4 mb-4 sm:grid-cols-3 pb-2 border-b dark:border-gray-500">
                <FormInput label="Salary" type="number" name="salary" id="salary" value={applicant.salary} onchange={handleChange} placeholder="₱15,000 per month" require={true} />
                <FormInput label="Business" type="text" name="business" id="business" value={applicant.business} onchange={handleChange} placeholder="Name your business" require={true} />
            ...
            <div class="grid gap-4 mb-4 sm:grid-cols-3 pb-2 border-b dark:border-gray-500">
                <FormInput label="Living" type="number" name="living_exp" id="living" value={applicant.living_exp} onchange={handleChange} placeholder="Living expenses/month" require={true} />
                <FormInput label="Rental" type="number" name="rental_exp" id="rental" value={applicant.rental_exp} onchange={handleChange} placeholder="₱500 per month" require={true} />
                <FormInput label="Education" type="number" name="education_exp" id="education" value={applicant.education_exp} onchange={handleChange} placeholder="Education expenses/month" require={true} />
                <FormInput label="Transportation" type="number" name="transportation" id="transport" value={applicant.transportation} onchange={handleChange} placeholder="Transport expenses/month" require={true} />
                <FormInput label="Insurance" type="text" name="insurance" id="insurance" value={applicant.insurance} onchange={handleChange} placeholder="Insurance" require={true} />
                <FormInput label="Electricity/Water Bill" type="number" name="bills" id="bills" value={applicant.bills} onchange={handleChange} placeholder="Billing expenses/month" require={true} />
            </div>
