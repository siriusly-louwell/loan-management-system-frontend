    ...
    <div
      ...
      <div className="flex flex-col items-start mb-3 me-4 md:items-center md:flex-row md:mb-0">
        ...
        <p className="flex items-center text-sm font-normal text-gray-500 dark:text-gray-400">
          Inquire loans much faster by signing up to our website
        </p>
      </div>
      <div className="flex items-center shrink-0">
        <a
          href="#"
          className="px-5 py-2 me-2 text-xs font-medium text-white bg-rose-700 rounded-lg hover:bg-rose-800 focus:ring-4 focus:ring-rose-300 dark:bg-rose-600 dark:hover:bg-rose-700 focus:outline-none dark:focus:ring-rose-800">
          Sign up
        </a>
        <button
          type="button"
