...
export default function Alert({id, text, children, icon}) {
    return (
        <div id={id} tabIndex="-1" className="fixed hidden top-0 left-0 right-0 z-50 p-20 bg-gray-500 bg-opacity-30 justify-items-center items-center overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
