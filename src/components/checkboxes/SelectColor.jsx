...
export default function SelectColor({text, size, colors, changeColor, index, arr = [], colorType = 'all'}) {
    const bool = arr.length > 0;
    const spectrum = bool ? arr : (colorType !== 'ofc'
        ? [
            ...
            '#fefefe', '#f8f9fa', '#e5e4e2', '#c0c0c0', '#f60c00', '#d70000', '#b00020', '#990000', '#d2042d', '#ff4500', '#cba135',
            '#ffe600', '#ffd700', '#ccff00', '#a6e22e', '#4db849', '#556b2f', '#0033a0', '#007cf0',
