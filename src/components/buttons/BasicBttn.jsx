...
export default function BasicButton({ text, click }) {
  const color =
    text !== "Show more"
      ? "dark:border-gray-400 dark:bg-gray-700 dark:text-gray-400 dark:hover:bg-gray-600 dark:focus:ring-gray-600"
      : "dark:border-gray-600 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-700";
