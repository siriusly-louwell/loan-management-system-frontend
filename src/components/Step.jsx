...
export default function Step({label, status}) {
    const style = status == 'current' ? "text-blue-700 border-blue-300 dark:border-blue-800 dark:text-blue-400"
        : (status == 'done' ? "text-green-700 border-green-300 dark:border-green-800 dark:text-green-400"
