...
export default function Eligibity({ loan, url }) {
  ...
  return (
    <div
      id="eligibleModal"
      className="overflow-y-auto hidden overflow-x-hidden fixed bg-gray-400 dark:bg-gray-700 bg-opacity-60 dark:bg-opacity-60 top-0 right-0 left-0 z-50 flex items-center justify-center w-full md:inset-0 h-[calc(100%-1rem)] md:h-full">
                ...
                <tr className="border-b border-gray-400">
                  ...
                  <td className="py-4">
                    <div className="grid grid-cols-2 gap-x-6">
                      ...
                      <span className="text-md font-bold mt-2 text-gray-600">
                        DTI Ratio:
                      </span>
              ...
              {location.pathname === "/staff/loan" ? (
                <>
                  ...
                  <CustomBttn
                    text="Decide Verdict"
                    onclick={() => {
                      document.getElementById("decideAppModal").style.display =
                        "block";
                    }}
