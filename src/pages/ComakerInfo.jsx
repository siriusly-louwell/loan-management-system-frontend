    ...
    return (
        <>
            ...
            <div class="grid gap-4 mb-4 sm:grid-cols-3 pb-2 border-b dark:border-gray-500">
                <FormInput label="First name" type="text" name="prod_name" id="name" placeholder="Type first name here" require={true} />
                <FormInput label="Middle name" type="text" name="prod_name" id="name" placeholder="Type middle name here" require={true} />
                <FormInput label="Last name" type="text" name="prod_name" id="name" placeholder="Type last name here" require={true} />
                <FormInput label="Date of Birth" type="date" name="prod_name" id="name" require={true} />
                <FormInput label="Place of Birth" type="text" name="prod_name" id="name" placeholder="Birth place address" require={true} />
                <FormSelect name="gender" label="Sex" id="gender" require={true}>
                    <option>Male</option>
                    <option>Female</option>
                    <option>Prefer not to say</option>
                </FormSelect>
                <FormSelect name="status" label="Civil Status" id="status" require={true}>
            ...
            <div class="grid gap-4 mb-4 sm:grid-cols-3 pb-2">
                <FormSelect name="country" label="Country" id="country" value={comaker.country} onchange={comakeChange} require={true}>
                ...
                <FormSelect name="region" label="Region" id="region" value={comaker.region} onchange={comakeChange} require={true}>
                ...
                <FormSelect name="province" label="Province" id="province" value={comaker.province} onchange={comakeChange} require={true}>
                ...
                <FormSelect name="city" label="Municipality/City" id="city" value={comaker.city} onchange={comakeChange} require={true}>
                ...
                <FormSelect name="brgy" label="Barangay" id="brgy" value={comaker.brgy} onchange={comakeChange} require={true}>
            ...
            <FormCheck label="Copy Residential Address" type="checkbox" id="copy_address" style="mb-4" change={copycomake} />
            <div class="grid gap-4 mb-4 sm:grid-cols-3 pb-2 border-b dark:border-gray-500">
                <FormInput label="Country" type="text" name="perm_country" id="country" value={comaker.perm_country} onchange={comakeChange} placeholder="Type country here" require={true} />
                <FormInput label="Region" type="text" name="perm_region" id="region" value={comaker.perm_region} onchange={comakeChange} placeholder="Type region here" require={true} />
                <FormInput label="Province" type="text" name="perm_province" id="province" value={comaker.perm_province} onchange={comakeChange} placeholder="Type province here" require={true} />
                <FormInput label="City/Municipality" type="text" name="perm_city" id="city" value={comaker.perm_city} onchange={comakeChange} placeholder="Type city here" require={true} />
                <FormInput label="Barangay" type="text" name="perm_brgy" id="brgy" value={comaker.perm_brgy} onchange={comakeChange} placeholder="Type barangay here" require={true} />
            </div>

            <div class="grid gap-4 mb-4 sm:grid-cols-3 pb-2 border-b dark:border-gray-500">
                <FormInput label="Citizenship" type="text" name="prod_name" id="name" placeholder="Type citizenhip" require={true} />
                <FormInput label="Occupation" type="text" name="prod_name" id="name" placeholder="Type occupation here" require={true} />
                <FormInput label="Years of Service" type="text" name="prod_name" id="name" placeholder="Type last name here" require={true} />
            ...
            <div class="grid gap-4 mb-4 sm:grid-cols-3 pb-2 border-b dark:border-gray-500">
                ...
                <FormSelect name="province" label="Province" id="province" require={true}>
                    <option>Zamboanga del norte</option>
                    <option>Zamboanga del sur</option>
                    <option>Zamboanga sibugay</option>
                    <option>Davao del norte</option>
                ...
                <FormSelect name="city" label="Municipality/City" id="city" require={true}>
                    <option>Davao City</option>
                    <option>Panabo City</option>
                    <option>Tagum City</option>
                    <option>Samal Island</option>
