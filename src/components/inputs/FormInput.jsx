...
export default function FormInput({label, id, type, name, min, value, onchange, placeholder, require = false, styling}) {
    return (
        <div>
            <label htmlFor={id} className={"block mb-2 text-sm font-medium text-gray-900 dark:text-white "+styling}>{label} {require ? (<strong className='text-rose-500'>*</strong>) : ''}</label>
