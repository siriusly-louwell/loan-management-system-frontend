            ...
            <aside id="default-sidebar" class="sticky top-0 left-0 z-40 w-64 h-0 sm:h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
                <div class="h-full px-3 border border-gray-800 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-900">
                    <ul class="space-y-2 font-medium">
                        <SidebarLink text="Dashboard" notif="">
                            <Chart />
                        </SidebarLink>
                        <SidebarLink text="Widgets" notif="">
                            <Widget />
                        </SidebarLink>
                        <SidebarLink text="Notifications" notif={<Notif num="3" />}>
                            <Mailbox />
                        </SidebarLink>
                        <SidebarLink text="Users" notif="">
                            <Users />
                        </SidebarLink>
                        <SidebarLink text="Products" notif="">
                            <Basket />
                        </SidebarLink>
                        <SidebarLink text="Sign In" notif="">
                        ...
                        <SidebarLink text="Sign Up" notif="">
