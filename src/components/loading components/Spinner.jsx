...
export default function Spinner({id, text}) {
    // const gradientId = `spinnerGradient-${Math.random().toString(36).substring(2, 9)}`;

    return (
        <div id={id} className="fixed hidden left-0 right-0 md:inset-0 h-full w-full flex justify-center items-center bg-gray-100 bg-opacity-50 dark:bg-gray-700 dark:bg-opacity-50">
            {/* <div className="grid gap-3">
                <div className="flex items-center justify-center">
                    <svg className="animate-spin border-indigo-600" xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 40 40" fill="none">
                ...
                <span className="text-black text-sm font-normal leading-snug dark:text-gray-300">Loading...</span>
            </div> */}
            ...
            <div className="grid gap-3">
                <div className="flex items-center justify-center">
                    <svg className="animate-spin border-indigo-600" xmlns="http://www.w3.org/2000/svg" width="54" height="54" viewBox="0 0 54 54" fill="none">
                        <g id="Group 1000003701">
                            <circle id="Ellipse 715" cx="26.9998" cy="26.9998" r="20" transform="rotate(90 26.9998 26.9998)" stroke="#b2beb5" stroke-width="4" />
                ...
                <span className="text-rose-600 text-sm font-normal leading-snug dark:text-rose-500">{text}</span>
            </div>

            {/* <div className="grid gap-3">
                <div className="flex items-center justify-center">
                    <svg className="animate-spin border-indigo-600" xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewBox="0 0 64 64" fill="none">
