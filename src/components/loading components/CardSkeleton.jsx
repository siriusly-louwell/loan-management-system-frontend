...
export default function CardSkeleton({ num = 4 }) {
  return [...Array(num)].map((_, i) => (
    <div
      key={i}
      role="status"
      className="max-w-sm bg-white shadow-sm dark:bg-gray-700 rounded-lg p-4">
      <div className="animate-pulse w-full bg-gray-200 dark:bg-gray-500 h-48 rounded-lg mb-5 flex justify-center items-center">
        <svg
      ...
      <div className=" w-full flex justify-between mt-20 items-start animate-pulse">
        <div className="block">
