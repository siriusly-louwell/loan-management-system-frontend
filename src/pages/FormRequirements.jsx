    ...
    return (
        <>
            ...
            <div class="grid gap-4 mb-4 sm:grid-cols-2 pb-2 border-b dark:border-gray-500">
                <FileInput label="Valid ID" type="img" change={fileChange} />
                <FileInput label="2x2 Picture" type="img" change={fileChange} />
                <FileInput label="Proof of Residence" type="pdf" change={fileChange} />
                <FileInput label="Proof of Income" type="pdf" change={fileChange} />
            </div>
        </>
    );
}