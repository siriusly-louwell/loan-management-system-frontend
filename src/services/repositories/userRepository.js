...
export const userRepository = {
  async fetchAll() {
    ...
    if (!response) return { message: "Failed to fetch users", type: "error" };
  ...
  async fetchAccount(id) {
    ...
    if (!response) return { message: "Failed to fetch account", type: "error" };
  ...
  async add(data) {
    ...
    if (!response) return { message: "Failed to create user", type: "error" };
  ...
  async register(data) {
    ...
    if (!response)
      return { message: "Failed to register applicant", type: "error" };
