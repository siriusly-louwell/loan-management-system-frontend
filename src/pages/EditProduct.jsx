...
export default function EditProduct({motor}) {
    ...
    async function handleSubmit(event) {
        ...
        try {
            const response = await axios.post(`http://127.0.0.1:8000/api/motorcycle/${formEdit.id}`, editData);
                ...
                <div className="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5 border border-gray-500">
                    ...
                    <form onSubmit={handleSubmit} className="lg:flex">
                        <section className="lg:w-1/2 lg:pr-3">
                            ...
                            <div className="grid gap-4 mb-4 sm:grid-cols-2">
                                <FormInput label="Motorcycle Name" type="text" value={formEdit.name || ''} onchange={handleChange} name="name" id="name" />
                                <FormInput label="Brand Name" type="text" name="brand" id="brand" value={formEdit.brand || ''} onchange={handleChange} />
                                <div className="grid gap-4 sm:col-span-2 md:gap-6 sm:grid-cols-3">
                                    <FormInput label="Price" type="number" id="price" name="price" value={formEdit.price || ''} onchange={handleChange} />
                                    <FormInput label="Minimum Downpayment" type="number" id="down" name="downpayment" value={formEdit.downpayment || ''} onchange={handleChange} />
                                    <FormInput label="Rebate" type="number" id="rebate" name="rebate" value={formEdit.rebate || ''} onchange={handleChange} />
                                ...
                                {rows.map((_, i) => (
                                    <>
                                        ...
                                        <div className="sm:flex space-x-2 items-center mb-3">
                                            ...
                                            {editColor.length > 0 && editColor[i] ? (<ColorLabel style={editColor[i]} />) : ''}
                        ...
                        <section className="lg:w-1/2 border-l border-gray-300 lg:pl-3">
                            ...
                            <div className="grid gap-4 mb-5 pb-2 border-b sm:grid-cols-2">
                                <FormInput label="Engine" type="text" value={formEdit.engine || ''} onchange={handleChange} name="engine" id="name" />
                                <FormInput label="Compression Ratio" type="text" value={formEdit.compression || ''} onchange={handleChange} name="compression" id="name" />
                                <div className="grid gap-4 sm:col-span-2 md:gap-6 sm:grid-cols-3">
                                    <FormInput label="Displacement (cc)" type="text" value={formEdit.displacement || ''} onchange={handleChange} name="displacement" id="name" />
                                    <FormInput label="Horsepower (hp)" type="text" value={formEdit.horsepower || ''} onchange={handleChange} name="horsepower" id="name" />
                                    <FormInput label="Torque (Nm)" type="text" value={formEdit.torque || ''} onchange={handleChange} name="torque" id="name" />
                                    <FormInput label="Fuel System" type="text" value={formEdit.fuel || ''} onchange={handleChange} name="fuel" id="name" />
                                    <FormInput label="Final Drive" type="text" value={formEdit.drive || ''} onchange={handleChange} name="drive" id="name" />
                                    <FormInput label="Transmission" type="text" value={formEdit.transmission || ''} onchange={handleChange} name="transmission" id="name" />
                                </div>
                                <FormInput label="Cooling System" type="text" value={formEdit.cooling || ''} onchange={handleChange} name="cooling" id="name" />
                            </div>
                            <div className="grid gap-4 mb-5 pb-2 border-b sm:grid-cols-2">
                                <FormInput label="Front Suspension" type="text" value={formEdit.front_suspension || ''} onchange={handleChange} name="front_suspension" id="name" />
                                <FormInput label="Rear Suspension" type="text" value={formEdit.rear_suspension || ''} onchange={handleChange} name="rear_suspension" id="name" />
                                <div className="grid gap-4 sm:col-span-2 md:gap-6 sm:grid-cols-3">
                                    <FormInput label="Frame Type" type="text" value={formEdit.frame || ''} onchange={handleChange} name="frame" id="name" />
                                    <FormInput label="Front/Rear Travel (mm/in)" type="text" value={formEdit.travel || ''} onchange={handleChange} name="travel" id="name" />
                                    <FormInput label="Swingarm Type" type="text" value={formEdit.swingarm || ''} onchange={handleChange} name="swingarm" id="name" />
                                </div>
                            </div>
                            <div className="grid gap-4 mb-5 pb-2 border-b sm:grid-cols-2">
                                <div className="grid gap-4 sm:col-span-2 md:gap-6 sm:grid-cols-3">
                                    <FormInput label="Dry Weight" type="text" value={formEdit.dry_weight || ''} onchange={handleChange} name="dry_weight" id="name" />
                                    <FormInput label="Wet weight" type="text" value={formEdit.wet_weight || ''} onchange={handleChange} name="wet_weight" id="name" />
                                    <FormInput label="Seat Height (mm/in)" type="text" value={formEdit.seat || ''} onchange={handleChange} name="seat" id="name" />
                                    <FormInput label="Wheelbase" type="text" value={formEdit.wheelbase || ''} onchange={handleChange} name="wheelbase" id="name" />
                                    <FormInput label="Fuel Tank Capacity" type="text" value={formEdit.fuel_tank || ''} onchange={handleChange} name="fuel_tank" id="name" />
                                    <FormInput label="Ground Clearance" type="text" value={formEdit.clearance || ''} onchange={handleChange} name="clearance" id="name" />
                                </div>
                            </div>
                            <div className="grid gap-4 mb-5 pb-2 border-b sm:grid-cols-2">
                                <div className="grid gap-4 sm:col-span-2 md:gap-6 sm:grid-cols-3">
                                    <FormInput label="Tire Size" type="text" value={formEdit.tires || ''} onchange={handleChange} name="tires" id="name" />
                                    <FormInput label="Wheel Type" type="text" value={formEdit.wheel || ''} onchange={handleChange} name="wheel" id="name" />
                                    <FormInput label="Brakes" type="text" value={formEdit.brakes || ''} onchange={handleChange} name="brakes" id="name" />
                                </div>
                            </div>
                            <div className="grid gap-4 mb-5 pb-2 border-b sm:grid-cols-2">
                                <FormInput label="ABS" type="text" value={formEdit.abs || ''} onchange={handleChange} name="abs" id="name" />
                                <FormInput label="Traction Control" type="text" value={formEdit.traction || ''} onchange={handleChange} name="traction" id="name" />
                                <FormInput label="TFT Display" type="text" value={formEdit.tft || ''} onchange={handleChange} name="tft" id="name" />
                                <FormInput label="Lighting" type="text" value={formEdit.lighting || ''} onchange={handleChange} name="lighting" id="name" />
                                <div className="grid gap-4 sm:col-span-2 md:gap-6 sm:grid-cols-3">
                                    <FormInput label="Riding Modes" type="text" value={formEdit.ride_mode || ''} onchange={handleChange} name="ride_mode" id="name" />
                                    <FormInput label="Quickshifter" type="text" value={formEdit.quickshifter || ''} onchange={handleChange} name="quickshifter" id="name" />
                                    <FormInput label="Cruise Control" type="text" value={formEdit.cruise || ''} onchange={handleChange} name="cruise" id="name" />
                                </div>
                            </div>
                            <div className="flex items-center space-y-4 sm:flex sm:space-y-0 sm:space-x-4">
                                <Button text="Save Changes" bttnType="submit"/>
                                <CustomBttn text="Move to Archive" classname="flex items-center whitespace-nowrap text-rose-700 hover:text-white border border-rose-700 hover:bg-rose-800 focus:ring-4 focus:outline-none focus:ring-rose-300 font-medium rounded-lg text-sm px-3 py-2 text-center dark:border-rose-500 dark:text-rose-500 dark:hover:text-white dark:hover:bg-rose-600 dark:focus:ring-rose-900">
                    ...
                    <Alert id="editUnit" text={alert.text} icon={alert.icon}>
                        <Button text="Ok" onclick={() => {
                            if(alert.icon === 'done')document.getElementById('editProduct').style.display = 'none';
