    ...
    <section className="bg-white flex items-center h-screen dark:bg-gray-800">
      <div className="px-4 mx-auto max-w-screen-xl lg:px-6">
        <div className="mx-auto max-w-screen-sm text-center">
          ...
          <p className="mb-4 text-2xl tracking-tight font-bold text-gray-400 lg:text-4xl dark:text-gray-400">
            Unauthorized Access
          </p>
          <p className="mb-4 text-lg font-light text-gray-500 dark:text-gray-500">
            Sorry, but you are not authorized to view or open this page. No authentication was provided
          </p>
          <Link
            to="/login"
