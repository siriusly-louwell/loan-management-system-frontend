...
export default function StepCard({num, label, context}) {
    return (
        <li className="p-10 rounded-lg md:shrink md:basis-0 flex-1 group flex gap-x-2 md:block bg-white dark:bg-gray-600">
            <div className="min-w-7 min-h-7 flex flex-col items-center md:w-full md:inline-flex md:flex-wrap md:flex-row text-xs align-middle">
                <span className="size-7 flex justify-center items-center shrink-0 bg-rose-500 font-medium text-gray-100 rounded-full dark:bg-rose-700 dark:text-white">{num}</span>
            ...
            <div className="grow md:grow-0 md:mt-3 pb-5">
                <span className="block text-lg font-medium text-gray-800 dark:text-white">{label}</span>
