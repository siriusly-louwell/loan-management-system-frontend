                    ...
                    <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                        ...
                        <div class="flex flex-col md:flex-row items-stretch md:items-center md:space-x-3 space-y-3 md:space-y-0 justify-between mx-4 py-4 border-t dark:border-gray-700">
                            <div class="w-full md:w-1/2">
                                <form class="flex items-center">
                                    ...
                                    <SearchInput name="findProd" id="simple-search" placeholder="Search for products...">
                                        <Search />
                                    </SearchInput>
                                </form>
                            </div>
                        ...
                        <div class="overflow-x-auto">
                            <Table>
                                ...
                                <tbody>
                                    <ProductRow prodName="Apple iMac 27" img="https://flowbite.s3.amazonaws.com/blocks/application-ui/products/imac-front-image.png" />
                                    <ProductRow prodName="Apple iPhone 14" img="https://flowbite.s3.amazonaws.com/blocks/application-ui/devices/apple-iphone-14.png" />
                                    <ProductRow prodName="Apple iPad Air" img="https://flowbite.s3.amazonaws.com/blocks/application-ui/devices/apple-ipad-air.png" />
                                    <ProductRow prodName="Xbox Series S" img="https://flowbite.s3.amazonaws.com/blocks/application-ui/devices/xbox-series-s.png" />
                                    <ProductRow prodName="PlayStation 5" img="https://flowbite.s3.amazonaws.com/blocks/application-ui/devices/playstation-5.png" />
                                    <ProductRow prodName="Xbox Series X" img="https://flowbite.s3.amazonaws.com/blocks/application-ui/devices/xbox-series-x.png" />
                                </tbody>
                            </Table>
                        </div>
                        <PageNav />
