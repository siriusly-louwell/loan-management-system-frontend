                ...
                <div className="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5 border border-gray-500">
                    ...
                    <form onSubmit={handleSubmit}>
                        <div className="grid gap-4 mb-4 sm:grid-cols-2">
                            ...
                            <FormInput label="File path" type="text" name="file_path" id="file" value={formData.file_path} onchange={handleChange} placeholder="Type brand name" />
                            <div className="grid gap-4 sm:col-span-2 md:gap-6 sm:grid-cols-3">
                                <FormSelect name="color" id="color" label="Color" value={formData.color} onchange={handleChange}>
