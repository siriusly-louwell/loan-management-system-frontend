                    ...
                    {(
                        <>
                            <div className="relative w-full space-y-4 lg:max-w-3xl mx-auto rounded-xl overflow-hidden">
                                ...
                                {unitLoad ? (
                                    <div className="flex justify-center items-center w-full h-full">
                                        <div className="w-full h-full rounded-lg bg-gray-200 dark:bg-pink-500 animate-pulse flex items-center justify-center">
                            ...
                            <div className="mt-6 sm:mt-8 lg:mt-0">
                                {unitLoad ? (
                                    <h1 className="h-5 bg-gray-200 rounded-full animate-pulse w-60 mb-4"></h1>
                                ) : (
                                ...
                                <div className="mt-4 sm:items-center sm:gap-4 sm:flex">
                                    {unitLoad ? (
                                        <p className="h-8 bg-gray-200 rounded-full animate-pulse w-40 mb-4"></p>
                                    ) : (
