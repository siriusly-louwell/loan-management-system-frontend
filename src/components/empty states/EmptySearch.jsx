  ...
  return (
    <div className="w-full flex items-center my-20 px-10 py-5 flex-wrap justify-center gap-10">
      <div className="grid gap-4 w-60">
        ...
        <div>
          <h2 className="text-center text-gray-500 text-xl font-semibold leading-loose pb-2">
            {label}
          </h2>
          <p className="text-center text-gray-500 text-base font-normal leading-relaxed pb-4">
            {context}
          </p>
        </div>
      </div>
