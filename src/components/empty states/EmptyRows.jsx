    ...
    <div className="flex flex-col my-10 py-20 items-center">
      <svg
        ...
        <rect
          ...
          rx="7.5"
          fill="white"
          className="dark:fill-gray-100"></rect>
        <rect
          x="27"
          y="50.5"
          width="124"
          ...
          rx="7.5"
          stroke="white"
          className="dark:stroke-gray-500/10"></rect>
        <rect
          x="34.5"
          y="58"
          width="24"
          ...
          rx="4"
          fill="white"
          className="dark:fill-gray-600/30"></rect>
        <rect
          x="66.5"
          y="61"
          width="60"
        ...
        <rect
          ...
          rx="7.5"
          fill="white"
          className="dark:fill-gray-800"></rect>
        <rect
          x="19.5"
          y="28.5"
          width="139"
          ...
          rx="7.5"
          stroke="white"
          className="dark:stroke-gray-600/30"></rect>
        <rect
          x="27"
          y="36"
          width="24"
          ...
          rx="4"
          fill="white"
          className="dark:fill-gray-600/70"></rect>
        <rect
          x="59"
          y="39"
          width="60"
        ...
        <g filter="url(#filter19)">
          ...
          <rect
            ...
            rx="7.5"
            stroke="white"
            className="dark:stroke-gray-600/60"
            shapeRendering="crispEdges"></rect>
          <rect
            x="20"
            y="14"
            ...
            rx="4"
            fill="white"
            className="dark:fill-gray-600 "></rect>
          <rect
            x="52"
            y="17"
            width="60"
      ...
      <div className="mx-auto mt-5 justify-items-center">
        ...
        <p className="text-gray-500 dark:text-gray-500">
          Add an account or change filters
        </p>
      </div>
    </div>
  );
