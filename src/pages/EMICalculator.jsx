    ...
    return (
        <div className="w-full overflow-hidden bg-gray-100 dark:bg-gray-800">
            <div className="w-full justify-items-center px-5">
                <h1 className="dark:text-white font-bold text-3xl">Motorcycle Loan Calculator</h1>
                <p className="text-gray-800 dark:text-gray-300">Calculate the monthly EMI based on motorcycle loan amount, tenure and interest rate</p>
            </div>
            ...
            <div className="py-20 sm:flex sm:space-x-20 items-center px-4 justify-center">
                <div className="sm:w-1/2 p-2">
                        ...
                        <div className="flex justify-between items-center mb-2">
                            ...
                            <h3 className="font-medium text-gray-700 flex gap-x-2 dark:text-gray-200">
                                Minimum Payment: {load ? (
                                    ...
                                    <span className="font-bold text-rose-600">₱{parseFloat(down).toLocaleString()}</span>
                                )}
                            </h3>
                    ...
                    <div className="mb-8">
                        <h3 className="font-medium text-gray-700 dark:text-gray-200 mb-3">Loan Tenure</h3>
                        <div className="grid grid-cols-5 gap-2">
                            <input type="radio" value checked={tenure === 12} className="hidden" />
                            {load ? (
                                <>
                ...
                {load ? (
                    ...
                    <div className="bg-white dark:bg-gray-600 rounded-2x1 shadow-lg sm:w-1/3 justify-items-center rounded-xl p-5 mb-4">
                        <p className="text-xl font-bold text-gray-800 dark:text-white mb-5">{brand} - {name}</p>
                        <div className="flex justify-between items-center space-x-5 mb-4">
                            <div className="justify-items-center">
                                <p className="text-gray-500 dark:text-gray-100 text-sm">Down Payment</p>
                                <p className="text-xl font-bold text-gray-800 dark:text-white">₱{parseFloat(downPayment).toLocaleString()}</p>
                            </div>
                            <div className="justify-items-center">
                                <p className="text-gray-500 dark:text-gray-100 text-sm">Loan Amount</p>
                                <p className="text-xl font-bold text-gray-800 dark:text-white">₱{parseFloat(loanAmount).toLocaleString()}</p>
                            </div>
                        </div>
                        <div className="border-t w-full justify-items-center border-gray-200 py-4">
                            <p className="text-gray-500 dark:text-gray-100 text-sm">Monthly EMI</p>
                            <p className="text-2xl font-bold text-rose-600 dark:text-rose-500">₱{parseFloat(emi).toLocaleString()}</p>
                        </div>
            ...
            {!staff ? (
                <div className="sm:px-10 py-20 w-full">
                    <div className="bg-rose-200 dark:bg-gray-700 p-5 rounded-xl shadow-lg justify-items-center space-y-5">
                        <h1 className="dark:text-white font-bold text-3xl">How Do I Apply?</h1>
