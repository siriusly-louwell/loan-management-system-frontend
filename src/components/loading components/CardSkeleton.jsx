...
export default function CardSkeleton() {
    return (
        <div role='status' class='max-w-sm bg-white shadow-sm dark:bg-gray-700 rounded-lg p-4'>
            <div class="animate-pulse w-full bg-gray-200 h-48 rounded-lg mb-5 flex justify-center items-center">
            ...
            <div class=' w-full flex justify-between items-start animate-pulse'>
                <div class="block">
                    <h3 class='h-3 bg-gray-300 rounded-full  w-60 mb-4'></h3>
                    <h3 class='h-3 bg-gray-300 rounded-full  w-58 mb-4'></h3>
                    <p class='h-2 bg-gray-300 rounded-full w-40 mb-2.5'></p>
                    <p class='h-2 bg-gray-300 rounded-full w-50 mb-2.5'></p>
                    <p class='h-2 bg-gray-300 rounded-full w-50 mb-2.5'></p>
                </div>
            </div>
        </div>
