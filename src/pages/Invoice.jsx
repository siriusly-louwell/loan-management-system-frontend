...
//   const { paymentID, paymentLoading } = useSelector((state) => state.payment);
...
export const Invoice = React.forwardRef((props, some, ref) => (
  <section ref={ref} className="p-4 bg-white dark:bg-gray-800/90 rounded-lg">
    ...
    <div className="mt-6 border border-gray-200 dark:border-gray-500 p-4 rounded-lg space-y-4">
      <div className="hidden sm:grid sm:grid-cols-5">
        ...
        <div className="text-xs font-medium text-gray-500 uppercase">Brand</div>
        <div className="text-start text-xs font-medium text-gray-500 uppercase">
          Qty
        </div>
        <div className="text-start text-xs font-medium text-gray-500 uppercase">
      ...
      <div className="grid grid-cols-3 sm:grid-cols-5 gap-2">
        ...
        <div>
          ...
          {props.loanLoading ? (
            ...
            <ColorLabel style={props.unit?.color || ""} />
          )}
        </div>
        <div>
          <h5 className="sm:hidden text-xs font-medium text-gray-500 uppercase">
