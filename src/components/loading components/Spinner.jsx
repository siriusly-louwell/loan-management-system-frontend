...
export default function Spinner({ id, text }) {
  ...
  return (
    <div
      id={id}
      className="fixed hidden left-0 right-0 md:inset-0 h-full w-full flex justify-center items-center bg-gray-100 bg-opacity-50 dark:bg-gray-700 dark:bg-opacity-50">
          ...
          <svg
            ...
            <g id="Group 1000003701">
              <circle
                ...
                cy="26.9998"
                r="20"
                transform="rotate(90 26.9998 26.9998)"
                stroke="#b2beb5"
                strokeWidth="4"
              />
              <path
