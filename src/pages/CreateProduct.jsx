                        ...
                        <section className="lg:w-1/2 lg:pr-3">
                            ...
                            <div className="grid gap-4 mb-4 sm:grid-cols-2">
                                ...
                                <div className="grid gap-4 sm:col-span-2 md:gap-6 sm:grid-cols-3">
                                    ...
                                    <FormSelect label="Brand Name" name="brand" id="brand" value={formData.brand || ''} onchange={handleChange}>
                                        <option>Honda</option>
                                ...
                                {rows.map((_, i) => (
                                    <>
                                        ...
                                        <div className="sm:flex justify-between items-center mb-3">
                                            ...
                                            <QuantityInput max={200} label="Quantity" index={i} change={handleQuantity} />
                                        </div>
                                    </>
