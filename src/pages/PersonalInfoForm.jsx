    ...
    return (
        <>
            ...
            <div className="grid gap-4 mb-4 sm:grid-cols-3 pb-2 border-b dark:border-gray-500">
                ...
                <FormInput label="Contact Number" type="number" name="contact_num" min={99999999999} id="contact_num" value={applicant.contact_num} onchange={handleChange} placeholder="+63 912 3456 789" require={true} disable={disable} />
                <FormInput label="Email Address" type="email" name="email" id="email" value={applicant.email} onchange={handleChange} placeholder="doe@gmail.com" disable={disable} />
                <FormSelect name="status" label="Marital Status" id="status" value={applicant.status} onchange={handleChange} require={true} disable={disable}>
            ...
            <div className={"grid gap-4 mb-4 pb-2 " + (applicant.view ? 'flex w-full' : 'sm:grid-cols-3')}>
                {applicant.view ? (
                    ...
                    <>
                        <FormSelect name="region" label="Region" id="region" value={address.region} onchange={addressChange} require={true} disable={disable}>
                        ...
                        <FormInput label="Purok" type="text" name="purok" id="purok" value={address.purok} onchange={addressChange} placeholder="Type purok number here" require={true} disable={disable} />
                        <FormInput label="Lot/House Number" type="text" name="lot_num" id="lot_num" value={address.lot_num} onchange={addressChange} placeholder="Type House number here" require={true} disable={disable} />
                    </>
                )}
            </div>
            ...
            <div className={"grid gap-4 mb-4 pb-2 " + (applicant.view ? 'flex w-full' : 'sm:grid-cols-3')}>
                {applicant.view ? (
                    ...
                    <>
                        <FormInput label="Region" type="text" name="prev_region" id="region" value={address.prev_region} onchange={addressChange} placeholder="Type region here" require={true} disable={disable} />
                        <FormInput label="Province" type="text" name="prev_province" id="province" value={address.prev_province} onchange={addressChange} placeholder="Type province here" require={true} disable={disable} />
